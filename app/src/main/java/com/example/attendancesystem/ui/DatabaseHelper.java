...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_CLASS_TABLE = "CREATE TABLE " + CLASS_TABLE_NAME+
    ...
    public static final String SELECT_STATUS_TABLE = "SUBJECT * FROM "+STATUS_TABLE_NAME;
...
//    class table methods
    ...
    public long addStudent(long cid, Integer roll, String name) {
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(C_ID,cid);
    ...
    public int deleteStudent(long cid) {
        SQLiteDatabase database = this.getReadableDatabase();
        return database.delete(STUDENT_TABLE_NAME,S_ID+"=?",new String[]{String.valueOf(cid)});
    }
    ...
    public long updateStatus(long sid,long cid,String date,String status) {
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(STATUS_KEY,status);
        values.put(S_ID,sid);
